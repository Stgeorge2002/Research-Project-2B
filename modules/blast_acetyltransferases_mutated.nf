// modules/blast_acetyltransferases_mutated.nf
process BLAST_ACETYLTRANSFERASES_MUTATED {
    tag "BLASTing mutated acetyltransferases"
    publishDir "${params.outputDir}/blast_results/mutated", mode: 'copy'
